/**
 * @brief           Contains hardware specific defines for SBC66EC Revision 1 board.
 * @file            brd_sbc32ul-r1.h
 * @author          <a href="www.modtronix.com">Modtronix Engineering</a>
 * @compiler        MPLAB XC32 Compiler
 *
 * @section sbc32ul_r1_desc Description
 *****************************************
 * This module includes hardware specific defines for SBC66EC Revision 1 board.
 *
 **********************************************************************
 * @section sbc32ul_r1_lic Software License Agreement
 *
 ...
 */
    ...
    //#if defined(__PIC32MX450F256H__)
...
// *********************************************************************
// ----------- Daughter Board Connector Defines for SBC66EC ------------
// *********************************************************************
#define PORT_ID_MAX          41  //ID of highest used port ID
#define DUMMY_REG               CNPUB
...
#define PULLUP_00       DUMMY_REG  //Complete code!
#define PULLDOWN_00      DUMMY_REG  //Complete code!
#define PPS_OUT_00      DUMMY_REG  //Complete code!
#define PPS_IN_00       0
...
#define PULLUP_01       DUMMY_REG  //Complete code!
#define PULLDOWN_01      DUMMY_REG  //Complete code!
#define PPS_OUT_01      DUMMY_REG  //Complete code!
#define PPS_IN_01       1
...
#define PULLUP_02       DUMMY_REG  //Complete code!
#define PULLDOWN_02      DUMMY_REG  //Complete code!
#define PPS_OUT_02      DUMMY_REG  //Complete code!
#define PPS_IN_02       13
...
#define PULLUP_03       DUMMY_REG  //Complete code!
#define PULLDOWN_03      DUMMY_REG  //Complete code!
...
#define PULLUP_04       DUMMY_REG  //Complete code!
#define PULLDOWN_04      DUMMY_REG  //Complete code!
#define PPS_OUT_04      DUMMY_REG  //Complete code!
#define PPS_IN_04       28
...
#define PULLUP_05       DUMMY_REG  //Complete code!
#define PULLDOWN_05      DUMMY_REG  //Complete code!
#define PPS_OUT_05      DUMMY_REG  //Complete code!
#define PPS_IN_05       18
...
#define PULLUP_06       DUMMY_REG  //Complete code!
#define PULLDOWN_06      DUMMY_REG  //Complete code!
#define PPS_OUT_06      DUMMY_REG  //Complete code!
#define PPS_IN_06       21
...
#define PULLUP_07       DUMMY_REG  //Complete code!
#define PULLDOWN_07      DUMMY_REG  //Complete code!
#define PPS_OUT_07      DUMMY_REG  //Complete code!
#define PPS_IN_07       26
...
#define PULLUP_08       DUMMY_REG  //Complete code!
#define PULLDOWN_08      DUMMY_REG  //Complete code!
#define PPS_OUT_08      DUMMY_REG  //Complete code!
#define PPS_IN_08       19
...
#define PULLUP_09       DUMMY_REG  //Complete code!
#define PULLDOWN_09      DUMMY_REG  //Complete code!
#define PPS_OUT_09      DUMMY_REG  //Complete code!
#define PPS_IN_09       27

#define UCPORT_10       G8
#define UCPORT_ID_10    UCPORT_ID_G8
#define PIN_10          _RG8
#define PIN_10_BITADR   ((volatile WORD)(/*Bit8=0x8nnn*/0x82F2/*PORTG=0x02F2*/ ))
#define LAT_10          _LATG8
#define LAT_10_BITADR   ((volatile WORD)(/*Bit8=0x8nnn*/0x82F4/*LATG=0x02F4*/ ))
#define DIR_10          _TRISG8
#define TRIS_10_BITADR  ((volatile WORD)(/*Bit8=0x8nnn*/0x82F0/*TRISG=0x02F0*/ ))
#define PULLUP_10       DUMMY_REG  //Complete code!
#define PULLDOWN_10      DUMMY_REG  //Complete code!
#define PPS_OUT_10      DUMMY_REG  //Complete code!
#define PPS_IN_10       19

#define UCPORT_11       G9
#define UCPORT_ID_11    UCPORT_ID_G9
#define PIN_11          _RG9
#define PIN_11_BITADR   ((volatile WORD)(/*Bit9=0x9nnn*/0x92F2/*PORTG=0x02F2*/ ))
#define LAT_11          _LATG9
#define LAT_11_BITADR   ((volatile WORD)(/*Bit9=0x9nnn*/0x92F4/*LATG=0x02F4*/ ))
#define DIR_11          _TRISG9
#define TRIS_11_BITADR  ((volatile WORD)(/*Bit9=0x9nnn*/0x92F0/*TRISG=0x02F0*/ ))
#define PULLUP_11       DUMMY_REG  //Complete code!
#define PULLDOWN_11      DUMMY_REG  //Complete code!
#define PPS_OUT_11      DUMMY_REG  //Complete code!
#define PPS_IN_11       27
...
#define PULLUP_12        DUMMY_REG  //Complete code!
#define PULLDOWN_12       DUMMY_REG  //Complete code!
#define PPS_OUT_12       DUMMY_REG  //Complete code!
#define PPS_IN_12        4
...
#define PULLUP_13        DUMMY_REG  //Complete code!
#define PULLDOWN_13       DUMMY_REG  //Complete code!
#define PPS_OUT_13       DUMMY_REG  //Complete code!
#define PPS_IN_13        3
...
#define PULLUP_20       DUMMY_REG  //Complete code!
#define PULLDOWN_20      DUMMY_REG  //Complete code!
#define PPS_OUT_20      DUMMY_REG  //Complete code!
#define PPS_IN_20       6
...
#define PULLUP_21       DUMMY_REG  //Complete code!
#define PULLDOWN_21      DUMMY_REG  //Complete code!
#define PPS_OUT_21      DUMMY_REG  //Complete code!
#define PPS_IN_21       7

//#define UCPORT_22      0  //Dont define is not available!
#define UCPORT_ID_22     UCPORT_ID_NA
#define LAT_22_BITADR    BITADR_NA
#define PIN_22_BITADR    BITADR_NA
#define TRIS_22_BITADR   BITADR_NA

//#define UCPORT_23      0  //Dont define is not available!
#define UCPORT_ID_23     UCPORT_ID_NA
#define LAT_23_BITADR    BITADR_NA
#define PIN_23_BITADR    BITADR_NA
#define TRIS_23_BITADR   BITADR_NA

//#define UCPORT_24      0  //Dont define is not available!
#define UCPORT_ID_24     UCPORT_ID_NA
#define PIN_24_BITADR    BITADR_NA
#define LAT_24_BITADR    BITADR_NA
#define TRIS_24_BITADR   BITADR_NA

//#define UCPORT_25      0  //Dont define is not available!
#define UCPORT_ID_25     UCPORT_ID_NA
#define PIN_25_BITADR    BITADR_NA
#define LAT_25_BITADR    BITADR_NA
#define TRIS_25_BITADR   BITADR_NA
...
#define PULLUP_26       DUMMY_REG  //Complete code!
#define PULLDOWN_26      DUMMY_REG  //Complete code!
#define PPS_OUT_26      DUMMY_REG  //Complete code!
...
#define PULLUP_27       DUMMY_REG  //Complete code!
#define PULLDOWN_27      DUMMY_REG  //Complete code!
#define PPS_OUT_27      DUMMY_REG  //Complete code!
#define PPS_IN_27       16
...
#define PULLUP_28       DUMMY_REG  //Complete code!
#define PULLDOWN_28      DUMMY_REG  //Complete code!
#define PPS_OUT_28      DUMMY_REG  //Complete code!
#define PPS_IN_28       10

#define UCPORT_29       D8
#define UCPORT_ID_29    UCPORT_ID_D8
#define PIN_29          _RD8
#define PIN_29_BITADR   ((volatile WORD)(/*Bit8=0x8nnn*/0x82DA/*PORTD=0x02DA*/ ))
#define LAT_29          _LATD8
#define LAT_29_BITADR   ((volatile WORD)(/*Bit8=0x8nnn*/0x82DC/*LATD=0x02DC*/ ))
#define DIR_29          _TRISD8
#define TRIS_29_BITADR  ((volatile WORD)(/*Bit8=0x8nnn*/0x82D8/*TRISD=0x02D8*/ ))
#define PULLUP_29       DUMMY_REG  //Complete code!
#define PULLDOWN_29      DUMMY_REG  //Complete code!
#define PPS_IN_29       2
...
#define PULLUP_30        DUMMY_REG  //Complete code!
#define PULLDOWN_30       DUMMY_REG  //Complete code!
#define PPS_OUT_30       DUMMY_REG  //Complete code!
#define PPS_IN_30        8
...
#define PULLUP_31        DUMMY_REG  //Complete code!
#define PULLDOWN_31       DUMMY_REG  //Complete code!
#define PPS_OUT_31       DUMMY_REG  //Complete code!
#define PPS_IN_31        9
...
#define PULLUP_32        DUMMY_REG  //Complete code!
#define PULLDOWN_32       DUMMY_REG  //Complete code!
...
#define PULLUP_33        DUMMY_REG  //Complete code!
#define PULLDOWN_33       DUMMY_REG  //Complete code!

#define UCPORT_34       B12
#define UCPORT_ID_34     UCPORT_ID_B12
#define PIN_34           _RB12
#define PIN_34_BITADR   ((volatile WORD)(/*Bit12=0xCnnn*/0xC2CA/*PORTB=0x02CA*/ ))
#define LAT_34           _LATB12
#define LAT_34_BITADR   ((volatile WORD)(/*Bit12=0xCnnn*/0xC2CC/*LATB=0x02CC*/ ))
#define DIR_34           _TRISB12
#define TRIS_34_BITADR  ((volatile WORD)(/*Bit12=0xCnnn*/0xC2C8/*TRISB=0x02C8*/ ))
#define PULLUP_34        DUMMY_REG  //Complete code!
#define PULLDOWN_34       DUMMY_REG  //Complete code!

#define UCPORT_35       B13
#define UCPORT_ID_35     UCPORT_ID_B13
#define PIN_35           _RB13
#define PIN_35_BITADR   ((volatile WORD)(/*Bit13=0xDnnn*/0xD2CA/*PORTB=0x02CA*/ ))
#define LAT_35           _LATB13
#define LAT_35_BITADR   ((volatile WORD)(/*Bit13=0xDnnn*/0xD2CC/*LATB=0x02CC*/ ))
#define DIR_35           _TRISB13
#define TRIS_35_BITADR  ((volatile WORD)(/*Bit13=0xDnnn*/0xD2C8/*TRISB=0x02C8*/ ))
#define PULLUP_35        DUMMY_REG  //Complete code!
#define PULLDOWN_35       DUMMY_REG  //Complete code!
...
#define PULLUP_36        DUMMY_REG  //Complete code!
#define PULLDOWN_36       DUMMY_REG  //Complete code!
#define PPS_OUT_36       DUMMY_REG  //Complete code!
#define PPS_IN_36        11
...
#define PULLUP_37        DUMMY_REG  //Complete code!
#define PULLDOWN_37       DUMMY_REG  //Complete code!
#define PPS_OUT_37       DUMMY_REG  //Complete code!
#define PPS_IN_37        24
...
#define PULLUP_38        DUMMY_REG  //Complete code!
#define PULLDOWN_38       DUMMY_REG  //Complete code!
#define PPS_OUT_38       DUMMY_REG  //Complete code!
#define PPS_IN_38        23
...
#define PULLUP_39        DUMMY_REG  //Complete code!
#define PULLDOWN_39       DUMMY_REG  //Complete code!
#define PPS_OUT_39       DUMMY_REG  //Complete code!
#define PPS_IN_39        22
...
#define PULLUP_40        DUMMY_REG  //Complete code!
#define PULLDOWN_40       DUMMY_REG  //Complete code!
...
#define PULLUP_41        DUMMY_REG  //Complete code!
#define PULLDOWN_41       DUMMY_REG  //Complete code!
...
#define UCPORT_ID_SCL   UCPORT_ID_29
...
//#define UCPORT_SDA3     0  //Dont define is not available!

//#define UCPORT_SCL3     0  //Dont define is not available!
...
#define ADC_CHANNEL_MASK_LOW_BRD  0b0011111100111111    //AN0-AN5, AN8-AN13
...
#define ADC_CH_A10       12  //AN12
#define ADC_CH_A11       13  //AN13
...
#define ADC_OPEN_A10     0x1000  //AN12
#define ADC_OPEN_A11     0x2000  //AN13
...
#define PULLUP_SYSLED   DUMMY_REG  //Complete code!
#define PULLDOWN_SYSLED  DUMMY_REG  //Complete code!
...
#define UC_PORT_B12_PROP    (UCPORT_PROP_DIG_IN | UCPORT_PROP_DIG_OUT | UCPORT_PROP_ANALOG_IN | UCPORT_PROP_OPEN_COL |                   UCPORT_PROP_PULLUP | UCPORT_PROP_PULLDOWN)
#define UC_PORT_B13_PROP    (UCPORT_PROP_DIG_IN | UCPORT_PROP_DIG_OUT | UCPORT_PROP_ANALOG_IN | UCPORT_PROP_OPEN_COL |                   UCPORT_PROP_PULLUP | UCPORT_PROP_PULLDOWN)
...
#define UC_PORT_D8_PROP     (UCPORT_PROP_DIG_IN | UCPORT_PROP_DIG_OUT | UCPORT_PROP_OPEN_COL | UCPORT_PROP_RP | UCPORT_PROP_PULLUP | UCPORT_PROP_PULLDOWN | UCPORT_PROP_5V)
#define UC_PORT_D9_PROP     (UCPORT_PROP_DIG_IN | UCPORT_PROP_DIG_OUT | UCPORT_PROP_OPEN_COL | UCPORT_PROP_RP | UCPORT_PROP_PULLUP | UCPORT_PROP_PULLDOWN | UCPORT_PROP_5V)
#define UC_PORT_D10_PROP    (UCPORT_PROP_DIG_IN | UCPORT_PROP_DIG_OUT | UCPORT_PROP_OPEN_COL | UCPORT_PROP_RP | UCPORT_PROP_PULLUP | UCPORT_PROP_PULLDOWN | UCPORT_PROP_5V)
...
#define UC_PORT_F4_PROP     (UCPORT_PROP_DIG_IN | UCPORT_PROP_DIG_OUT | UCPORT_PROP_OPEN_COL | UCPORT_PROP_RP | UCPORT_PROP_PULLUP | UCPORT_PROP_PULLDOWN | UCPORT_PROP_5V)   /* Do NOT include SDA, seeing that matching SCL is not available */
    //G6, F7,G8,G9
...
#define ENC100_SCK_AL_IO                (LATBbits.LATB15)
    ...
    // ENC624J600 Interface Configuration, using PSP Mode 5
    // Comment out ENC100_INTERFACE_MODE if you don't have an ENC424J600.
    //  - 5: 8-bit multiplexed PSP Mode 5 with RD and WR pins
    #define ENC100_INTERFACE_MODE            5

    // Indirect addressing is used = reduced number of pins can be used 
    ...
    // SPI interface, then this section can be ignored or deleted.
        ...
        //For the SBC66EC, bit 8 uses AD8 pin
        #define ENC100_TRANSLATE_TO_PIN_ADDR(a)        ((a)&0x01FF)
    ...
    #define ENC100_BIT_BANG_PMP
        ...
        #if ENC100_INTERFACE_MODE == 5 || ENC100_INTERFACE_MODE == 6    // Mutliplexed 8-bit address/data modes
            #if defined(ENC100_PSP_USE_INDIRECT_RAM_ADDRESSING)    // Only ENCX24J600 address pins AD0-AD8 connected (AD9-AD14 tied to Vdd)
            #define ENC100_INIT_PSP_BIT_BANG()      do{ANSB &= 0x7FFF;} while(0)        // RE0-RE7, RF5, RD4, RD5 (AD0-AD7, AD8, WR, RD) pins are already digital only pins.  RB15 (AL) needs to be made digital only.

            // TODO To optimize code size, check if F5 can be left as output!
            //#define ENC100_SET_AD_TRIS_IN()       do{((volatile BYTE*)&TRISE)[0] = 0xFF;}while(0)
            #define ENC100_SET_AD_TRIS_IN()         do{((volatile BYTE*)&TRISE)[0] = 0xFF; TRISFbits.TRISF5 = 1;}while(0)

            #define ENC100_SET_AD_TRIS_OUT()        do{((volatile BYTE*)&TRISE)[0] = 0x00; TRISFbits.TRISF5 = 0;}while(0)
            #define ENC100_GET_AD_IO()              (((volatile BYTE*)&PORTE)[0])
            #define ENC100_SET_AD_IO(data)          do{WORD _wSetMacro = (data); ((volatile BYTE*)&LATE)[0] = (BYTE)_wSetMacro; LATFbits.LATF5 = 0; if(_wSetMacro & 0x0100) LATFbits.LATF5 = 1;}while(0)
...
#define PIN_SPIMEM_SDO          _RB14
#define LAT_SPIMEM_SDO          _LATB14
#define DIR_SPIMEM_SDO          _TRISB14
//#define PULLUP_SPIMEM_SDO     DUMMY_REG  //Complete code!
//#define PULLDOWN_SPIMEM_SDO    DUMMY_REG  //Complete code!
#define PPS_OUT_SPIMEM_SDO      DUMMY_REG  //Complete code!

#define PIN_SPIMEM_SCK          _RD11
#define LAT_SPIMEM_SCK          _LATD11
#define DIR_SPIMEM_SCK          _TRISD11
//#define PULLUP_SPIMEM_SCK     DUMMY_REG  //Complete code!
//#define PULLDOWN_SPIMEM_SCK    DUMMY_REG  //Complete code!
#define PPS_OUT_SPIMEM_SCK      DUMMY_REG  //Complete code!

#define PIN_SPIMEM_SDI          _RC14
#define LAT_SPIMEM_SDI          _LATC14
#define DIR_SPIMEM_SDI          _TRISC14
//#define PULLUP_SPIMEM_SDI     DUMMY_REG  //Complete code!
//#define PULLDOWN_SPIMEM_SDI    DUMMY_REG  //Complete code!
#define PPS_IN_SPIMEM_SDI       DUMMY_REG  //Complete code!
