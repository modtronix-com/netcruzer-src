/**
 * @brief           Contains hardware specific defines for SBC66EC Revision 2 board.
 * @file            brd_sbc66ec-r2.h
 * @author          <a href="www.modtronix.com">Modtronix Engineering</a>
 * @compiler        MPLAB XC16 Compiler
 *
 * @section sbc66ec_r2_desc Description
 *****************************************
 * This module includes hardware specific defines for SBC66EC Revision 2 board.
 *
 **********************************************************************
 * @section sbc66ec_r2_lic Software License Agreement
 *
...
#define PIN_SYSLED_BITADR   ((volatile WORD)(/*Bit6=0x6nnn*/0x62CA/*PORTB=0x02CA*/ ))
#define LAT_SYSLED_BITADR   ((volatile WORD)(/*Bit6=0x6nnn*/0x62CC/*LATB=0x02CC*/ ))
#define TRIS_SYSLED_BITADR  ((volatile WORD)(/*Bit6=0x6nnn*/0x62C8/*TRISB=0x02C8*/ ))
...
#define ENC100_SCK_AL_TRIS              (TRISBbits.TRISB12)
#define ENC100_SCK_AL_IO                (LATBbits.LATB12)
    ...
    #define ENC100_BIT_BANG_PMP
            ...
            #define ENC100_INIT_PSP_BIT_BANG()      do{ANSB &= 0xCFFF;} while(0)        // RE0-RE7, RD4, RD5 (AD0-AD7, AD8, WR, RD) pins are already digital only pins.  RB12 (AL) and RB13 (AD8) needs to be made digital only.

            // TODO To optimize code size, check if B13 can be left as output!
            //#define ENC100_SET_AD_TRIS_IN()       do{((volatile BYTE*)&TRISE)[0] = 0xFF;}while(0)
            #define ENC100_SET_AD_TRIS_IN()         do{((volatile BYTE*)&TRISE)[0] = 0xFF; TRISBbits.TRISB13 = 1;}while(0)

            #define ENC100_SET_AD_TRIS_OUT()        do{((volatile BYTE*)&TRISE)[0] = 0x00; TRISBbits.TRISB13 = 0;}while(0)
            #define ENC100_GET_AD_IO()              (((volatile BYTE*)&PORTE)[0])
            #define ENC100_SET_AD_IO(data)          do{WORD _wSetMacro = (data); ((volatile BYTE*)&LATE)[0] = (BYTE)_wSetMacro; LATBbits.LATB13 = 0; if(_wSetMacro & 0x0100) LATBbits.LATB13 = 1;}while(0)
...
#endif  //#if defined(BRD_SBC66EC_R2)
#endif