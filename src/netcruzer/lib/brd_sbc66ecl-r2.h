/**
 * @brief           Contains hardware specific defines for SBC66ECL Revision 2 board.
 * @file            brd_sbc66ecl-r2.h
 * @author          <a href="www.modtronix.com">Modtronix Engineering</a>
 * @compiler        MPLAB XC16 Compiler
 *
 * @section sbc66ecl_r2_desc Description
 *****************************************
 * This module includes hardware specific defines for SBC66EC Revision 2 board.
 *
 **********************************************************************
 * @section sbc66ecl_r2_lic Software License Agreement
 *
 ...
 *    - Initial version
 *********************************************************************/
#ifndef SBC66ECL_R2_H
#define SBC66ECL_R2_H
...
#define PULLUP_10       _CN10PUE
#define PULLDOWN_10      _CN10PDE
#define PPS_OUT_10      _RP19R
#define PPS_IN_10       19
...
#define PULLUP_11       _CN11PUE
#define PULLDOWN_11      _CN11PDE
#define PPS_OUT_11      _RP27R
#define PPS_IN_11       27
...
#define PULLUP_29       _CN53PUE
#define PULLDOWN_29      _CN53PDE
...
#define PULLUP_34        _CN30PUE
#define PULLDOWN_34       _CN30PDE
...
#define PULLUP_35        _CN31PUE
#define PULLDOWN_35       _CN31PDE
...
#define ADC_MAX_CHAN_BRD 12     //Maximum number of possible ADC channels, B0-B5, B8-B13
...
#define ENC100_SCK_AL_IO                (LATBbits.LATB15)
    ...
    // SPI interface, then this section can be ignored or deleted.
        ...
        //For the SBC66EC and SBC66ECL, bit 8 uses AD8 pin
    ...
    #define ENC100_BIT_BANG_PMP
            ...
            #define ENC100_INIT_PSP_BIT_BANG()      do{AD1PCFGL |= 0x8000;} while(0)        // RE0-RE7, RF5, RD4, RD5 (AD0-AD7, AD8, WR, RD) pins are already digital only pins.  RB15 (AL) needs to be made digital only.
...
//#define PULLUP_SPIMEM_SDO     _CN??PUE
//#define PULLDOWN_SPIMEM_SDO    _CN??PDE
#define PPS_OUT_SPIMEM_SDO      OUT_PIN_PPS_RP14

#define PIN_SPIMEM_SCK          _RD11
#define LAT_SPIMEM_SCK          _LATD11
#define DIR_SPIMEM_SCK          _TRISD11
//#define PULLUP_SPIMEM_SCK     _CN??PUE
//#define PULLDOWN_SPIMEM_SCK    _CN??PDE
...
//#define PULLUP_SPIMEM_SDI     _CN??PUE
//#define PULLDOWN_SPIMEM_SDI    _CN??PDE
