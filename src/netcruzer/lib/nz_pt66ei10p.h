 ...
 *
 * @section nz_pt66ei10p_desc Description
 *****************************************
 * This file includes hardware specific defines for the PT66EI-10P board. This board
 ...
 * file.
 *
 * @subsection nz_pt66ei10p_conf Configuration
 *****************************************
 ...
 *
 *
 * @subsection nz_pt66ei10p_usage Usage
 *****************************************
 * To use the PT66EI-10P with iMod modules in a project, the following must be done:
 * - Copy the @ref nz_pt66ei10p_conf "Configuration" section above (from nz_pt66ei10p.h)
 ...
 *
 *********************************************************************
 * @section nz_pt66ei10p_lic Software License Agreement
 *
