 ...
 *
 * @section nzos_semph_desc Description
 *****************************************
 * Netcruzer RTOS Functions
 * 
 * @subsection nzos_semph_conf Configuration
 *****************************************
 ...
 * contain desired configuration! For details, see @ref info_conf_proj "Project Configuration".
 @code
// *********************************************************************
// ----------- RTOS Semaphore Configuration (from nzos_semph.h) ------------
// *********************************************************************
#define nzosSEMAPHORE_ENABLE                   ( 0 )
