/**
 * @brief           Netcruzer RTOS Queue
 * @file            nzos_queue.h
 * @author          <a href="www.modtronix.com">Modtronix Engineering</a>
 * @compiler        MPLAB XC16 & XC32 Compilers
 *
 * @section nzos_queue_desc Description
 *****************************************
 * Netcruzer RTOS Functions
 * 
 * @subsection nzos_queue_conf Configuration
 *****************************************
 ...
 * contain desired configuration! For details, see @ref info_conf_proj "Project Configuration".
 @code
// *********************************************************************
// ----------- RTOS Queue Configuration (from nzos_queue.h) ------------
// *********************************************************************
#define nzosQUEUE_ENABLE                       ( 0 )
