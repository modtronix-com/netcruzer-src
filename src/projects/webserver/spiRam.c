 ...
 * \date 25 July 2007
********************************************************************/
#define __SPIRAM_C              //This define is used by the Microchip code
#define THIS_IS_SPI_RAM_C
...
/*********************************************************************
 * Function:        void xramGetArray(WORD wAddress, BYTE *vData, WORD wLength)
 *
 * PreCondition:
 *
 * Input:
...
/*********************************************************************
 * Function:        void xramPutArray(WORD wAddress, BYTE *vData, WORD wLength)
 *
 * PreCondition:
 *
 * Input:
...
#if defined(__18CXX)
void xramPutROMArray(WORD wAddress, ROM BYTE *vData, WORD wLength)
{
    volatile BYTE Dummy;
    BYTE vSPIONSave;
    BYTE SPICON1Save;
