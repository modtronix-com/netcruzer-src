/********************************************************************
 FileName:      HWP brd_sbc66ecl-r2.h
...
// Set configuration fuses (but only once)
	...
	// - RP Register Protection (PSP Configure) = Unlimited Writes To RP Registers (IOL1WAY_OFF)
    ...
    #define EEPROM_SDO_TRIS	(_TRISB14)
    ...
    #define SPIFLASH_SDO_TRIS       (TRISBbits.TRISB14)
