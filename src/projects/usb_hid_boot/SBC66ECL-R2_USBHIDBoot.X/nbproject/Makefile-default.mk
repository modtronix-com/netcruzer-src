...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/SBC66ECL-R2_USBHIDBoot.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/SBC66ECL-R2_USBHIDBoot.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=24FJ128GB106
MP_LINKER_FILE_OPTION=,--script="..\Bootloader Files\boot_hid_boot_p24FJ128GB106.gld"
# ------------------------------------------------------------------------------------
...
${OBJECTDIR}/_ext/1472/main.o: ../main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../main.c  -o ${OBJECTDIR}/_ext/1472/main.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1472/main.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -omf=elf -Os -I".." -I"../../../netcruzer/lib" -I"../../../microchip/Include" -I"../../../microchip/Include/USB" -I"../Configs" -I"../../../microchip/USB" -DBRD_SBC66ECL_R2 -msmart-io=1 -Wall -msfr-warn=off
...
${OBJECTDIR}/_ext/1472/main.o: ../main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1472/main.o.d 
	@${RM} ${OBJECTDIR}/_ext/1472/main.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../main.c  -o ${OBJECTDIR}/_ext/1472/main.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1472/main.o.d"      -g -omf=elf -Os -I".." -I"../../../netcruzer/lib" -I"../../../microchip/Include" -I"../../../microchip/Include/USB" -I"../Configs" -I"../../../microchip/USB" -DBRD_SBC66ECL_R2 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/main.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/_ext/1472/spiEEProm.o: ../spiEEProm.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1472/spiEEProm.o.d 
	@${RM} ${OBJECTDIR}/_ext/1472/spiEEProm.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../spiEEProm.c  -o ${OBJECTDIR}/_ext/1472/spiEEProm.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1472/spiEEProm.o.d"      -g -omf=elf -Os -I".." -I"../../../netcruzer/lib" -I"../../../microchip/Include" -I"../../../microchip/Include/USB" -I"../Configs" -I"../../../microchip/USB" -DBRD_SBC66ECL_R2 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/spiEEProm.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/_ext/1472/spiFlashWinbond.o: ../spiFlashWinbond.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1472/spiFlashWinbond.o.d 
	@${RM} ${OBJECTDIR}/_ext/1472/spiFlashWinbond.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../spiFlashWinbond.c  -o ${OBJECTDIR}/_ext/1472/spiFlashWinbond.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1472/spiFlashWinbond.o.d"      -g -omf=elf -Os -I".." -I"../../../netcruzer/lib" -I"../../../microchip/Include" -I"../../../microchip/Include/USB" -I"../Configs" -I"../../../microchip/USB" -DBRD_SBC66ECL_R2 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/_ext/1472/spiFlashWinbond.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/SBC66ECL-R2_USBHIDBoot.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    ../Bootloader\ Files/boot_hid_boot_p24FJ128GB106.gld
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/SBC66ECL-R2_USBHIDBoot.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1  -omf=elf -Wl,--defsym=__MPLAB_BUILD=1,--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_ICD3=1,$(MP_LINKER_FILE_OPTION),--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--library-path="/C/Program Files/Microchip/MPLAB C30/lib",--library-path="../Bootloader Files",--no-force-link,--smart-io,-Map="${DISTDIR}/SBC66ECL-R2_USBHIDBoot.X.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/SBC66ECL-R2_USBHIDBoot.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   ../Bootloader\ Files/boot_hid_boot_p24FJ128GB106.gld
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/SBC66ECL-R2_USBHIDBoot.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -Wl,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--library-path="/C/Program Files/Microchip/MPLAB C30/lib",--library-path="../Bootloader Files",--no-force-link,--smart-io,-Map="${DISTDIR}/SBC66ECL-R2_USBHIDBoot.X.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
	${MP_CC_DIR}\\xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/SBC66ECL-R2_USBHIDBoot.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf 
	
	@echo Normalizing hex file
	@"C:/Program Files (x86)/Microchip/MPLABX/mplab_ide/mplab_ide/modules/../../bin/hexmate" --edf="C:/Program Files (x86)/Microchip/MPLABX/mplab_ide/mplab_ide/modules/../../dat/en_msgs.txt" dist/${CND_CONF}/${IMAGE_TYPE}/SBC66ECL-R2_USBHIDBoot.X.${IMAGE_TYPE}.hex -odist/${CND_CONF}/${IMAGE_TYPE}/SBC66ECL-R2_USBHIDBoot.X.${IMAGE_TYPE}.hex
