...
//#define STACK_USE_GENERIC_TCP_CLIENT_EXAMPLE  // HTTP Client example in GenericTCPClient.c - if uncommented, remember to add GenericTCPClient.c to MPLAB project, and add call to
//#define STACK_USE_GENERIC_TCP_SERVER_EXAMPLE  // ToUpper server example in GenericTCPServer.c - if uncommented, remember to add GenericTCPServer.c to MPLAB project, and add call to
...
/* External FLASH start of File system. This defines gives the start of the MPFS File system.
 * Must be a multiple of the external FLASH sector size, given by XFLASH_SECTOR_SIZE define.
 * Sector size is 4096 by default.
 */
#define MPFS_RESERVE_BLOCK                (552960ul)
 ...
 */
#define MY_DEFAULT_HOST_NAME            "HM_KITCHEN "
#define MY_DEFAULT_HOST_NAME_           {'H','M','_','K','I','T','C','H','E','N',0} //Default Host name, maximum string lengh = 15 characters (16 including NULL terminator)
 ...
 */
    ...
    #define TCP_ETH_RAM_SIZE                    (15638ul)
...
#define UDP_USE_TX_CHECKSUM             // This slows UDP TX performance by nearly 50%, except when using the ENCX24J600,
...
// -- HTTP2 Server options -----------------------------------------------
    ...
    #define HTTP_MPFS_UPLOAD_REQUIRES_AUTH    // Require password for MPFS uploads Certain firewall and router
                                                //combinations cause the MPFS2 Utility to fail when uploading.
                                                //If this happens, comment out this definition.
