...
#if !defined(DEBUG_CONF_IP)
    #define DEBUG_CONF_IP        DEBUG_CONF_DEFAULT   //Default Debug Level, disabled if DEBUG_LEVEL_ALLOFF defined, else DEBUG_LEVEL_ERROR
#endif
#define MY_DEBUG_LEVEL   DEBUG_CONF_IP
#include "nz_debug.h"
