...
#define RXSTART_NOLIMIT     (TXSTART + 1518ul + TCP_ETH_RAM_SIZE + RESERVED_HTTP_MEMORY + RESERVED_SSL_MEMORY + RESERVED_CRYPTO_MEMORY + 1ul)
#if ((RXSTART_NOLIMIT + 1400) > RAMSIZE)
#error "RAMSIZE error! Not enough memory available!" RXSTART_NOLIMIT
#endif
