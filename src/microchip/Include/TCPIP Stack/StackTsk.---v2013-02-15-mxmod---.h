...
#include "appConfig.h"  //MODTRONIX added this line. Contains defs commented out below
//MODTRONIX commented code below from here
//Code below was moved to appConfig.h and appConfig.c
/*
