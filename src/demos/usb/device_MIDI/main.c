/**
 * @example usb/device_MIDI/main.c
 *
 * <h2>===== Description =====</h2>
 ...
 * when pressed. To change port, change following line in HardwareProfile.h:
 * "#define sw2 PIN_05"
 *
 ...
 * This project is located in the "src/demos/usb/device_MIDI" folder of the <a target="_blank" href="http://netcruzer.com/nzdownload/">Netcruzer
