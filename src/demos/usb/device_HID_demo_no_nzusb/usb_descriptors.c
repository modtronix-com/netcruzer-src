...
#pragma romdata
    ...
    ROM USB_DEVICE_DESCRIPTOR device_dsc=
    {
        ...
        0x04D8,                 // Vendor ID
        0xF8E2,                 // PID - Product ID: Modtronix Netcruzer CDC RS-232 Emulator (SBC66EC, SBC66ECL, ....)
    ...
    ROM USB_DEVICE_DESCRIPTOR device_dsc=
    {
        ...
        0xF8E1,                 // PID - Product ID: Modtronix Netcruzer USB HID Terminal (SBC66EC, SBC66ECL, ....)
