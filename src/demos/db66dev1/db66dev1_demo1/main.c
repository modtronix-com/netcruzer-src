/**
 * @example db66dev1_demo1/main.c
 *
 * <h2>===== Description =====</h2>
 * This demo contains some test code for the <a href="http://netcruzer.com/db66dev1.html">DB66DEV1</a>
 ...
 * This project is located in the "src/demos/db66dev1/db66dev1_demo1" folder of the <a target="_blank" href="http://netcruzer.com/nzdownload/">Netcruzer
