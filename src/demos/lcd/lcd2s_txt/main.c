/**
 * @example lcd2s_txt/main.c
 *
 * <h2>===== Description =====</h2>
 * This demo shows how to write "Hello World" to a LCD2S serial LCD display using the lcd2c.h and nz_lcd2s.c driver. It also
 * flashes the system LED. To add LCD2S support to a project, do the following:
 ...
 * This project is located in the "src/demos/lcd/lcd2s_txt" folder of the <a target="_blank" href="http://netcruzer.com/nzdownload/">Netcruzer
