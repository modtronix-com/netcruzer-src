...
/////////////////////////////////////////////////
//Expansion Boards and iMod modules

//Define any expansion boards, is a XBRD_xxx define (see nz_board.h for supported boards).
#define XBRD_PT66DIN6_R1    //This demo uses the PT66DIN6 DIN rail board

//Define iMod modules
//#define IMOD1_IS_IM2BL      //iMod port 2 has a im2BL module
